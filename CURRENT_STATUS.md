## 2026-09-19 — Issues #44, #45, #50, #51, #48 (эпик #43): навигация/шапка/статьи

- #44 (PR #57): Header.tsx — убран дубль "Помощник" из верхнего меню
  (route /assistant остаётся, используется из /articles), порядок
  Главная/Новости/Библиотека, добавлен aria-current.
- #45 (тот же PR #57): группировка Статьи/Глоссарий/Ссылки в dropdown
  "Библиотека" (click/hover, aria-haspopup/expanded, закрытие по клику
  снаружи).
